        ...
        match seleccion:
            case 1:
                ...
                nombre_ingresado = input(
                    f"Ingrese el nombre del estudiante {num_estudiante}: "
                )
                nota1_ingresada = float(
                    input(f"Ingrese la primera nota del estudiante {num_estudiante}: ")
                )
                nota2_ingresada = float(
                    input(f"Ingrese la segunda nota del estudiante {num_estudiante}: ")
                )
                estudiantes.append(
                    Alumno(nombre_ingresado, nota1_ingresada, nota2_ingresada)
                )
            ...
            case 2:
                ...
                for i in range(len(estudiantes)):
                    print(
                        f"{estudiantes[i].nombre}, Promedio: {(estudiantes[i].nota1 + estudiantes[i].nota2) / 2}"
                    )
            case 3:
                print("Adiós! :3")
                break
