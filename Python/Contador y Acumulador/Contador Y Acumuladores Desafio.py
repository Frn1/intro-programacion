...
def desafio():
    ...
    for i in range(cantidad):
        legajo = float(
            input(f"Introduzca la cantidad de años de legajo del empleado {i + 1}: ")
        )
    ...
    for empleado in empleados:
        ...
        if (
            empleado_con_mayor_salario == None
            or empleado.salario > empleado_con_mayor_salario.salario
        ):
    ...
    print(
        f"Cantidad de empleados que ganan más de $200000: {cantidad_empleados_que_ganan_mas_de_200000}"
    )
    print(
        f"Cantidad de empleados que ganan menos de $50000 y son de categoría 3: {cantidad_empleados_que_ganan_menos_de_50000_con_categoria_3}"
    )
