Algoritmo CalculadoraInfinita
	Definir seguirEjecutando Como Logico
	Definir n1, n2 Como Real
	Definir selección Como Entero
	seguirEjecutando <- Verdadero
	Mientras seguirEjecutando Hacer
		...
		Si selección == 5 Entonces
			// Parar la ejecución del bucle
			seguirEjecutando <- Falso
		SiNo Si selección < 1 o selección > 5 Entonces
